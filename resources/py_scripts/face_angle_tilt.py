...
face_cascade = cv.CascadeClassifier('./resources/py_scripts/haarcascade_frontalface_default.xml') 
eye_cascade = cv.CascadeClassifier("./resources/py_scripts/haarcascade_eye.xml") 
